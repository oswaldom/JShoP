...
@NamedQueries({
    ...
    @NamedQuery(name = "OrdenProducto.findByIdOrdenProducto", query = "SELECT o FROM OrdenProducto o WHERE o.ordenProductoPK.idOrdenProducto = :idOrdenProducto"),
    @NamedQuery(name = "OrdenProducto.findByCantidad", query = "SELECT o FROM OrdenProducto o WHERE o.cantidad = :cantidad"),
    @NamedQuery(name = "OrdenProducto.findByPrecio", query = "SELECT o FROM OrdenProducto o WHERE o.precio = :precio"),
    @NamedQuery(name = "OrdenProducto.findByPkFkOrden", query = "SELECT o FROM OrdenProducto o WHERE o.ordenProductoPK.pkFkOrden = :pkFkOrden"),
    @NamedQuery(name = "OrdenProducto.findByPkFkProducto", query = "SELECT o FROM OrdenProducto o WHERE o.ordenProductoPK.pkFkProducto = :pkFkProducto")})
