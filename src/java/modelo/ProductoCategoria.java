...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "ProductoCategoria.buscarTodo", query = "SELECT p FROM ProductoCategoria p"),
    @NamedQuery(name = "ProductoCategoria.buscarPorIdProductoCategoria", query = "SELECT p FROM ProductoCategoria p WHERE p.productoCategoriaPK.idProductoCategoria = :idProductoCategoria"),
    @NamedQuery(name = "ProductoCategoria.buscarPorPkFkProducto", query = "SELECT p FROM ProductoCategoria p WHERE p.productoCategoriaPK.pkFkProducto = :pkFkProducto"),
    @NamedQuery(name = "ProductoCategoria.buscarPorPkFkCategoria", query = "SELECT p FROM ProductoCategoria p WHERE p.productoCategoriaPK.pkFkCategoria = :pkFkCategoria")})
