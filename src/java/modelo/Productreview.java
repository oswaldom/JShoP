...
@NamedQueries({
    ...
    @NamedQuery(name = "Productreview.findByIdProductreview", query = "SELECT p FROM Productreview p WHERE p.productreviewPK.idProductreview = :idProductreview"),
    @NamedQuery(name = "Productreview.findByRating", query = "SELECT p FROM Productreview p WHERE p.rating = :rating"),
    @NamedQuery(name = "Productreview.findByTextoReview", query = "SELECT p FROM Productreview p WHERE p.textoReview = :textoReview"),
    @NamedQuery(name = "Productreview.findByPkFkCliente", query = "SELECT p FROM Productreview p WHERE p.productreviewPK.pkFkCliente = :pkFkCliente"),
    @NamedQuery(name = "Productreview.findByPkFkProducto", query = "SELECT p FROM Productreview p WHERE p.productreviewPK.pkFkProducto = :pkFkProducto")})
public class Productreview implements Serializable {
    ...
    public String toString() {
        return "modelo.Productreview[ productreviewPK=" + productreviewPK + " ]";
    }
