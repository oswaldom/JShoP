...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Tipodepago.buscarTodo", query = "SELECT t FROM Tipodepago t"),
    @NamedQuery(name = "Tipodepago.buscarPorIdTipodepago", query = "SELECT t FROM Tipodepago t WHERE t.idTipodepago = :idTipodepago"),
    @NamedQuery(name = "Tipodepago.buscarPorNumeroTdc", query = "SELECT t FROM Tipodepago t WHERE t.numeroTdc = :numeroTdc"),
    @NamedQuery(name = "Tipodepago.buscarPorFechaVencimiento", query = "SELECT t FROM Tipodepago t WHERE t.fechaVencimiento = :fechaVencimiento"),
    @NamedQuery(name = "Tipodepago.buscarPorMarcacomercial", query = "SELECT t FROM Tipodepago t WHERE t.marcacomercial = :marcacomercial")})
