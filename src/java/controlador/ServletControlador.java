...
import persistencia.ProductreviewFacade;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userPath.equals("/categoria")) {
            ...
            if (idProducto != null) {
                ...
                List<Cliente> clientesComentan = productReviewFacade.comentariosPorCliente(productoSeleccionado.getIdProducto());
                session.setAttribute("clientesComentan", clientesComentan);
                //                if (!clientes.isEmpty()){
...
//                    Iterator j = c.getProductreviewList().iterator();
//                Productreview pr;
//                while (j.hasNext()) {
//                    pr = (Productreview)j.next();
...
//                }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userPath.equals("/agregarAlCarrito")) {
        ...
        } else if (userPath.equals("/calificar")) {
            //TODO
            //verificar si el cliente compro el producto
            //clienteFacade.buscarEnCompras(int idProducto)
            ...
            if (request.getParameter("star-rating") == null) {
                ...
                rating = Integer.parseInt(request.getParameter("star-rating"));
            }
            System.out.println(idProducto + " " + comentario + " " + rating);
            userPath = "";
            altPath = "/JShoP/producto?" + idProducto;
            clienteFacade.calificarProducto(correoElectronico, idProducto, rating, comentario);
        }
        String url;
        if (!userPath.equals("")) {
            url = "/WEB-INF/vista" + userPath + ".jsp";
