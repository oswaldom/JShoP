...
public class ManejadorOrden {
    ...
    public int placeOrder(Cliente cliente, CarritoCompra carrito,String direccionEntrega,Lugar fkLugar) {

        try {
            Orden orden = agregarOrden(cliente, carrito,direccionEntrega,fkLugar);
    ...
    private Orden agregarOrden(Cliente cliente, CarritoCompra carrito,String direccionEntrega,Lugar fkLugar) {
    ...
    private void addOrderedItems(Orden orden, CarritoCompra carrito) {
        ...
        for (CarritoCompraItem ccItem : items) {
            ...
            orden.getOrdenProductoList().add(itemOrdenado);
        }
    ...
    public Map getOrderDetails(int idOrden) {
        ...
        List<OrdenProducto> productosOrdenados = ordenProductoFacade.buscarPorFkOrden(idOrden);
