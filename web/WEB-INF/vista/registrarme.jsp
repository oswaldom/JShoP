<div id="singleColumn">
    ...
    <form id="login_form" action="<c:url value='registrar'/>" method="post">
        <div id="datosLogin">
            ...
            <td>
            <tr><h2><label for="contrasena">Contraseña:</label>
                <label for="contrasenaVal" style="margin-left:135px">Confirme contraseña:</label></h2></tr> 
        ...
        <div id="datosDireccion">
            <td>
            <tr><h2><label for="direccion">Dirección:</label>
                <label for="codPostal" style="margin-left:140px;">Código postal:</label></h2></tr> 
...
var lugarSeleccionado = tripType.options[metodoDePago.selectedIndex].value;
            ...
            <br>
            <br>
                <button class="btn btn-success" type="submit" style="height: 35px; width: 150px; float: left; margin-left: 140px;" value="Registrarme!">
                Registrarme!
                </button>
        </div>
