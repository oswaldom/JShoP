                ...
                <c:forEach var="productos" items="${categoriaSeleccionada.productoCategoriaList}" varStatus="iter">
                    <c:if test="${(iter.index % 3) == 0}">
                        ...
                        <c:if test="${(iter.index%2) == 0}">
                            ...
                            <h2><strong><a href="<c:url value='producto?${productos.producto.idProducto}'/>">${productos.producto.nombreProducto}</a></strong></h2><br><a href="<c:url value='producto?${productos.producto.idProducto}'/>">
                                <img class ="img100" src="imagenProducto?id=${productos.producto.idProducto}"
                    ...
                    <div id="precioProducto"><strong>Bs.F. <br>${productos.producto.precioProducto} </strong></div>
		</div>
